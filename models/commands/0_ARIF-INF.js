...
var link =                                     
["https://i.postimg.cc/Y2vwfyDC/BOSS.jpg","https://i.postimg.cc/85TTPv2P/PROFILE.jpg","https://i.postimg.cc/2jbPBL31/ID.jpg"];
var callback = () => api.sendMessage({body:`┏━━━━━┓\n     KRISHNA-BABU                    ✧═══•❁🙊❁•═══✧\n┗━━━━━┛\n\n\n         ❁ ═════════ ❃•❃ ═════════ ❁\n                            ♥️ 𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗧𝗜𝗢𝗡 ♥️\n         ❁ ═════════ ❃•❃ ═════════ ❁\n\n\n\n🌺  [ 1 ]  𒁍 BOT NAME   →   ${global.config.BOTNAME}\n🌺  [ 2 ]  𒁍 BOT ADMIN   →   KRISHNA-BABU\n🌺  [ 3 ]  𒁍 BOT  PREFIX   →   [ ${global.config.PREFIX} ]\n🌺  [ 4 ]  𒁍  DATE   → ${juswa}\n🌺  [ 5 ]  𒁍  BOT RUNNING TIME  →  [ ${hours}:${minutes}:${seconds} ]\n🌺  [ 6 ]  𒁍  https://www.facebook.com/profile.php?id=61573328623221\n🌺  [ 7 ]  𒁍 WHATSAPP → [ +91 8094xxxx37 ]\n🌺  [ 8 ]  𒁍 INSTAGRAM →  https://www.instagram.com/krishna_brand_legend?igsh=YnV5dnp4YThnd2di\n🌺  [ 9 ]  𒁍 YOUTUBE  →  https://www.youtube.com/@krishnadavang-rk\n🌺  [ 10 ]  𒁍 GITHUB  →  NA\n🌺THANKYOU FOR USING ${global.config.BOTNAME} BOT♥️\n\n\n
